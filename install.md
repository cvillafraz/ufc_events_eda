# ufc_events_eda guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `ufc_events_eda/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `ufc_events_eda` folder and use the modules inside your notebooks :
...
```python
from ufc_events_eda.utils.paths import data_dir
data_dir()
```
